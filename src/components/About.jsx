        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-600 mb-4 leading-relaxed">
              Located in the historic land of Chauri Chaura, Gorakhpur,
              Mahadev Prashad Inter College stands as a beacon of knowledge
              and discipline.
            </p>

            <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed">
              Our campus provides a safe, inclusive, and stimulating environment
              where every student is encouraged to ask questions, explore ideas,
