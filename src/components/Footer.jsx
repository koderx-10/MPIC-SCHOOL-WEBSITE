      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-10 md:mb-12">
          ...
          <div className="col-span-2 md:col-span-2 lg:col-span-1 space-y-4">
            ...
            <p className="text-slate-400 leading-relaxed text-sm sm:text-base">
              Mahadev Prashad Inter College is committed to quality education,
              discipline, and digital learning for students in Chauri Chaura.
            </p>
          ...
          <div>
            ...
            <h3 className="text-white font-bold text-base mb-4 md:mb-6">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              {academics.map((item) => (
                ...
                <li
                  key={item}
                  className="text-sm hover:text-amber-500 transition-colors cursor-pointer"
                >
                  {item}
                </li>
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="mt-5 pt-5 border-t border-slate-800">
              ...
              <p className="text-xs sm:text-sm text-slate-400">
                Chauri Chaura, Gorakhpur, Uttar Pradesh - 273201
              </p>
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-center sm:text-left">
          ...
          <p className="text-xs sm:text-sm text-slate-500">
            © {new Date().getFullYear()} Mahadev Prashad Inter College.
            All rights reserved.
          </p>

          <p className="text-xs sm:text-sm text-slate-600">
            Powered by MPIC Digital Team
          </p>
