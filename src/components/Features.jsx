...
const Features = () => {
  const facilities = [
...

    {
      ...
      title: 'Computer Lab',
      desc: 'High-tech computer lab with internet connectivity.',
    },
...

    {
      ...
      desc: 'Large playground for cricket, football, and volleyball.',
    },

    {
      icon: <Music size={28} />,
      title: 'Cultural Center',
      desc: 'Auditorium for events, music, and dance practice.',
    },

    {
      icon: <Telescope size={28} />,
      title: 'Smart Learning',
      desc: 'Interactive digital learning environment with modern teaching methods and practical exposure.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-base md:text-xl text-gray-600 max-w-2xl mx-auto">
            We provide students with modern resources and practical learning opportunities for academic and personal growth.
          </p>
