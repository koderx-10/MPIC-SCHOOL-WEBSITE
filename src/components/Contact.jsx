  ...
  const contactItems = [
    {
      ...
      lines: [
        ...
        'Mundera bazaar, Chauri Chaura, Gorakhpur,',
...

    {
      ...
      title: 'Email Address',
      lines: [
        'info@mpic-chaurichaura.edu.in',
        'admissions@mpic-chaurichaura.edu.in',
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-blue-900 mb-5">
              Send Message
            </h3>
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-sm sm:text-base md:text-lg">
              ...
              Reach out or visit our campus in Chauri Chaura.
            </p>
